...
module](https://github.com/matrix-org/@dom-digital-online-media/matrix-react-sdk/blob/develop/src/customisations/Security.ts).
...
To customise visibility create a customisation module from [ComponentVisibility](https://github.com/matrix-org/@dom-digital-online-media/matrix-react-sdk/blob/master/src/customisations/ComponentVisibility.ts) following the instructions above.
