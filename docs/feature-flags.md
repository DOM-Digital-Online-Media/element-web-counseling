...
1. Add a new
   [setting](https://github.com/matrix-org/@dom-digital-online-media/matrix-react-sdk/blob/develop/src/settings/Settings.tsx)
   of the form:
...
1. Remove `isFeature` from the [setting](https://github.com/matrix-org/@dom-digital-online-media/matrix-react-sdk/blob/develop/src/settings/Settings.ts)
...
1. Remove the [setting](https://github.com/matrix-org/@dom-digital-online-media/matrix-react-sdk/blob/develop/src/settings/Settings.ts)
