...
const COPY_LIST = [
    ...
    ["node_modules/@dom-digital-online-media/matrix-react-sdk/res/media/**", "webapp/media"],
...
function genLangFile(lang, dest) {
    const reactSdkFile = "node_modules/@dom-digital-online-media/matrix-react-sdk/src/i18n/strings/" + lang + ".json";
